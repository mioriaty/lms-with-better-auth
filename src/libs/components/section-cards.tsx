...
import { Card, CardDescription, CardFooter, CardHeader, CardTitle } from '@/libs/components/ui/card';
import { TrendingDownIcon, TrendingUpIcon } from 'lucide-react';

export function SectionCards() {
  return (
    <div className="*:data-[slot=card]:shadow-xs grid grid-cols-1 gap-4 px-4 md:grid-cols-2 lg:grid-cols-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card lg:px-6">
